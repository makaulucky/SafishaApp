...
import { Roboto_All, Roboto_Regular, Roboto_Italic, Roboto_Thin, Roboto_Light, Roboto_Medium, Roboto_Bold, Roboto_Black, Roboto_ThinItalic, Roboto_LightItalic, Roboto_MediumItalic, Roboto_BoldItalic, Roboto_BlackItalic } from '../samples/Roboto';
describe('matchFontFace', () => {
  ...
  it('should not find a match for font family San Francisco', () => {
    expect(matchFontFace(Roboto_All, {

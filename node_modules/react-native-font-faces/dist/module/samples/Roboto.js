...
export const Roboto_LightItalic = {
  fontFamily: 'Roboto',
  fontWeight: '300',
  fontStyle: 'italic',
...
export const Roboto_BoldItalic = {
  fontFamily: 'Roboto',
  fontWeight: '700',
  fontStyle: 'italic',
  src: [local('Roboto-BoldItalic'), url('https://ff.static.1001fonts.net/r/o/roboto.bold-italic.ttf', 'truetype')]
};
export const Roboto_Black = {
  fontFamily: 'Roboto',
  fontWeight: '900',
  fontStyle: 'normal',
  src: [local('Roboto-Black'), url('https://ff.static.1001fonts.net/r/o/roboto.black.ttf', 'truetype')]
};
export const Roboto_BlackItalic = {
  fontFamily: 'Roboto',
  fontWeight: '900',
  fontStyle: 'italic',
  src: [local('Roboto-BlackItalic'), url('https://ff.static.1001fonts.net/r/o/roboto.black-italic.ttf', 'truetype')]
};
export const Roboto_All = [Roboto_Thin, Roboto_ThinItalic, Roboto_Light, Roboto_LightItalic, Roboto_Regular, Roboto_Italic, Roboto_Medium, Roboto_MediumItalic, Roboto_Bold, Roboto_BoldItalic, Roboto_Black, Roboto_BlackItalic];

...
exports.overrideTextInputRenderFn = overrideTextInputRenderFn;
...
const originalRenderFn = _reactNative.TextInput.render;

function overrideTextInputRenderFn() {
  class FontManager {
    applyOverrides() {
      _reactNative.TextInput.render = this.overrideRenderFn;
    }

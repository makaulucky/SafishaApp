...
var _getDynamicFontList = require("./getDynamicFontList");

describe('getDynamicFontList', () => {
  it('should correctly extract a react-native-dynamic-fonts font list', () => {
    expect((0, _getDynamicFontList.getDynamicFontList)(_Roboto.Roboto_All)).toEqual([{
...
//# sourceMappingURL=getDynamicFontList.spec.js.map
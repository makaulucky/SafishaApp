...
var _getExpoFontMap = require("./getExpoFontMap");

describe('getExpoFontMap', () => {
  it('should correctly extract an Expo font map', () => {
    expect((0, _getExpoFontMap.getExpoFontMap)(_Roboto.Roboto_All)).toEqual({
...
//# sourceMappingURL=getExpoFontMap.spec.js.map